...
class Governorate extends Model
{
    ...
    {
        return '
        <a href="'.route('dashboard.governorates.edit',$this->id) .'" class="btn btn-sm btn-primary btn-text-primary btn-hover-bg-success btn-icon mr-2" title="Edit details">
        ...
        <form action="'.route('dashboard.governorates.destroy',$this->id).'" method="post" style="    display: inline-block;">
