...
class City extends Model
{
    ...
    protected $fillable=['governorate_id','latitude','longitude'];
    ...
    {
        return '
        <a href="'.route('dashboard.cities.edit',$this->id) .'" class="btn btn-sm btn-primary btn-text-primary btn-hover-bg-success btn-icon mr-2" title="Edit details">
        ...
        <form action="'.route('dashboard.cities.destroy',$this->id).'" method="post" style="    display: inline-block;">
    ...
    {
        return $this->hasMany(\App\Models\Advertisement::class,'city_id');
    }
}
