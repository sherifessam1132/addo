    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('site.role.create')}}
        ...
        <div class="card-body">
            <form class="form" method="post" action="{{route('dashboard.roles.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <input id="kt_tagify_1" class="form-control tagify" name='permissions' placeholder='type...' value='' autofocus="" data-blacklist='.NET,PHP' />
                            <div class="mt-3">
