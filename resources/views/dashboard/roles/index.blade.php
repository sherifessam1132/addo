    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('site.role.all')}}
            ...
            var _demo = function() {
                ...
                var datatable = $('#kt_datatable').KTDatatable({
                    ...
                    columns: [
                        ...
                        {
                            field: 'permissions',
                            title: '{{__('site.role.permissions')}}',
                            sortable: false,
                            width: 250,
                            template: function (data) {
                                var permissions =`<div>`;
                                $.each(data.permissions,function (index, value){
                                    permissions += `<span class="label label-pill label-inline m-1">${value.name}</span>`
                                })
                                permissions += `</div>`
                                return permissions;
                            }
