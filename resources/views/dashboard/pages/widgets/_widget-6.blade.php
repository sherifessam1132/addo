                    ...
                    <tr>
                        ...
                        <td class="text-right pr-0">
                            <a href="#" class="btn btn-icon btn-light btn-sm">
                                {{ \App\Classes\Theme\Metronic::getSVG("media/svg/icons/General/Settings-1.svg", "svg-icon-md svg-icon-primary") }}
                            </a>
                            <a href="#" class="btn btn-icon btn-light btn-sm mx-3">
                                {{ \App\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}
                            </a>
                            <a href="#" class="btn btn-icon btn-light btn-sm">
                                {{ \App\Classes\Theme\Metronic::getSVG("media/svg/icons/General/Trash.svg", "svg-icon-md svg-icon-primary") }}
                            </a>
                        </td>
                    </tr>
                    <tr>
