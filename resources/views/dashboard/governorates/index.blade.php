    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('site.governorate.all')}}
{{--                    <div class="text-muted pt-2 font-size-sm">Datatable initialized from HTML table</div>--}}
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('dashboard.governorates.create')}}" class="btn btn-primary font-weight-bolder">
            ...
            var _demo = function() {
                ...
                var datatable = $('#kt_datatable').KTDatatable({
                    ...
                    columns: [
                        ...
                        {
                            field: 'name',
                            title: '{{__('site.governorate.name')}}',
                            template: function(data) {
                                return data.name ;
                            }
                        },
                        {
                            field: 'country.name',
                            sortable: false,
                            title: '{{__('site.governorate.country')}}',
                            template: function(data) {
