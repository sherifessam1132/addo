                ...
                <div class="card-body">
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $properties)
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="{{$locale}}[currency_name]" class="form-control @error($locale.'.currency_name') is-invalid @enderror" id="{{$locale}}_currency_name" value="{{old($locale.'.currency_name')}}" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="input-group date" id="currency_symbol" >
                                <input type="text" name="currency_symbol" id="currency_symbol" class="form-control  @error('currency_symbol') is-invalid @enderror"  value="{{old('currency_symbol')}}"/>
